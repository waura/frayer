...
class NormalBrushDrawTestSuite : public CxxTest::TestSuite
{
public:
	NormalBrushDrawTestSuite()
	{
	...
	void test_EditAfterMoveLayer()
	{
		...
		{//test edit
			IIETool* pTool = m_ImgEdit.GetIEToolFromName("NormalBrushDraw");
		...
		{//check edited layer image
			...
			//	cvSaveImage(".\\test_data\\Test_frayer\\NormalBrushDraw\\test_EditAfterMoveLayer.bmp", layer_img);
			//	cvReleaseImage(&layer_img);
			//}

			IplImageExt correct_img_ext;
			LoadIplImageExt(".\\test_data\\Test_frayer\\NormalBrushDraw\\test_EditAfterMoveLayer.bmp", &correct_img_ext);
