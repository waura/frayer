#ifndef _DARKENLAYRESYNTHESIZER_H_
#define _DARKENLAYERSYNTHESIZER_H_

#include "ILayerSynthesizer.h"


//”äŠr(ˆÃ)
class DarkenLayerSynthesizer : public ILayerSynthesizer
{
public:
	DarkenLayerSynthesizer(){};
	~DarkenLayerSynthesizer(){};
...
#endif //_DARKENLAYERSYNTHESIZER_H_