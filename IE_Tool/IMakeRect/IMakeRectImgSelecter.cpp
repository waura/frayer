...
IMakeRectImgSelecter::IMakeRectImgSelecter()
{
}
...
void IMakeRectImgSelecter::OnSelect()
{
	IMakeRect::OnSelect();
...
void IMakeRectImgSelecter::OnMouseRButtonDown(UINT nFlags, const LPPOINT lpt)
{
}

void IMakeRectImgSelecter::OnMouseRButtonUp(UINT nFlags, const LPPOINT lpt)
{
